...
julia --compiled-modules=no /scratch/ferpe/.julia/packages/LMC/3B4WF/src/cluster/drude.jl  $SLURM_ARRAY_TASK_ID $SLURM_ARRAY_TASK_MAX $SLURM_ARRAY_JOB_ID #$Ezmin $Ezmax $evals $N $eta