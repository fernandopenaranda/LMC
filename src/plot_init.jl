...
plot_lmc(kws...) = not_defined(kws...)
plot_drude(kws...) = not_defined(kws...)
plot_ahe(kws...) = not_defined(kws...)
plot_lmcspin(kws...) = not_defined(kws...)
hf_plotbands(kws...) = not_defined(kws...)
hf_plotbands!(kws...) = not_defined(kws...)
